class_name StateNikkeAim; extends StateNikke; @export var state_after_to_cover_animation: StateNikke;

@export var nikke_jiggle_effect_resources_when_aim_fire: Array[NikkeJiggleEffectResource];

func      _ready() -> void:
    super._ready()        ;
    for nikke_jiggle_effect_resource:NikkeJiggleEffectResource in nikke_jiggle_effect_resources_when_aim_fire:
...
func      _on_spine_sprite_animation_completed(_spine_sprite: Object, _animation_state: Object, _track_entry: Object) -> void:
    if   (_track_entry.get_animation().get_name() == "to_cover"):
        ...
        pass;
    elif (_track_entry.get_animation().get_name() == "aim_fire"):
        for nikke_jiggle_effect_resource: NikkeJiggleEffectResource in nikke_jiggle_effect_resources_when_aim_fire:
